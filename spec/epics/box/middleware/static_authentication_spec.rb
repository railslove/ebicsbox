require 'epics/box/middleware/static_authentication'
      ...
      RSpec.describe StaticAuthentication do
        ...
        describe 'user authentication' do
          ...
          describe 'authenticated user via query parameter' do
            let!(:organization) { Epics::Box::Organization.create(name: "Test Orga") }
            let!(:user) { Epics::Box::User.create(name: "Test User", access_token: 'test-token', organization: organization) }
