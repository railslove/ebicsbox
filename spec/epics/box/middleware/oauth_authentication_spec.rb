...
require 'epics/box/middleware/oauth_authentication'
      ...
      RSpec.describe OauthAuthentication do
        ...
        describe 'user authentication' do
          ...
          context 'existing organization and user' do
            let!(:organization) { Epics::Box::Organization.create(id: 1, name: "Test Orga") }
            let!(:user) { Epics::Box::User.create(id: 1, name: "Test User", organization: organization) }
