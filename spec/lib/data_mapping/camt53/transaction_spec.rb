...
require_relative "../../../../lib/data_mapping/camt53/transaction"

RSpec.describe DataMapping::Camt53::Transaction do
  let(:raw_bank_statement) do
    camt_file = File.read("spec/fixtures/camt_statement.xml")
    statement = SepaFileParser::String.parse(camt_file).statements.first
    statement.entries.first
  end
